...
void MM_Init() {
	MM_RegistExtensionFunction("StartMakeObjectFile", StartMakeObjectFile, 3);
	MM_RegistExtensionFunction("EndMakeObjectFile", EndMakeObjectFile, 0);
	MM_RegistExtensionFunction("WriteObject", WriteObject, 1);
