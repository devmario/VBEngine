        ...
        for(_i = 0; _i < _length; _i++) {
            ...
            if(_library_type == VBObjectFile2DLibraryType_Graphic || _library_type == VBObjectFile2DLibraryType_MovieClip) {
                ...
                for(_j = 0; _j < _key_frame_length; _j++) {
                    ...
                    if(_key_frame_element_type == VBObjectFile2DKeyFrameElementType_Graphic) {
                        _element_base = VBObjectFile2DKeyFrameElementGraphicInitWithData(VBObjectFile2DKeyFrameElementGraphicAlloc(), _transition, _matrix_wrapper, _color);
                        ...
                        _element_base = VBObjectFile2DKeyFrameElementMovieClipInitWithData(VBObjectFile2DKeyFrameElementMovieClipAlloc(), _instance_name, _transition, _matrix_wrapper, _color);
                ...
                for(_j = 0; _j < _key_frame_length; _j++) {
                    ...
                    if(_element_type == VBObjectFile2DKeyFrameElementType_Graphic) {
                        ...
                        if(VBObjectFile2DKeyFrameElementGraphicGetNext(_graphic)) {
                            ...
                            _key_frame_arr[_j]->none_real_time_color = VBSystemCalloc(sizeof(VBColorRGBA), _key_frame_length);
                            ...
                            _key_frame_arr[_j]->none_real_time_color = VBSystemCalloc(sizeof(VBColorRGBA), 1);
                        ...
                        *_key_frame_arr[_j]->none_real_time_color = VBColorRGBACreate(0xFF, 0xFF, 0xFF, 0xFF);
                    }
                }
            }
