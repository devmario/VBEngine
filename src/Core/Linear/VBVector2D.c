...
VBVector2D VBVector2DCrossProduct(VBVector2D _vec2D_1, VBVector2D _vec2D_2) {
    VBFloat _theta = sinf(VBVector2DAngleTo(_vec2D_1, _vec2D_2));
    return VBVector2DCreate(_vec2D_1.x * _vec2D_2.x * _theta, _vec2D_1.y * _vec2D_2.y * _theta);
}
