...
VBMatrix2D VBMatrix2DShear(VBMatrix2D _mat2D, VBFloat _sx, VBFloat _sy) {
	...
	_sMat2D.m12 += _mat2D.m11 * _sx;
	_sMat2D.m22 += _mat2D.m21 * _sx;
	_sMat2D.m32 += _mat2D.m31 * _sx;
	
	_sMat2D.m11 += _mat2D.m12 * _sy;
	_sMat2D.m21 += _mat2D.m22 * _sy;
	_sMat2D.m31 += _mat2D.m32 * _sy;
