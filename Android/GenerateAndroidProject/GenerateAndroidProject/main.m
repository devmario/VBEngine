...
int main (int argc, const char * argv[])
{
    ...
    @autoreleasepool {
        ...
        [mkStr appendString:@"LOCAL_LDLIBS := -L$(call host-path, $(LOCAL_PATH)/../../) -lcocos2d -lcocosdenshion \\\n"];
        [mkStr appendString:@"\t\t-L$(call host-path, $(LOCAL_PATH)/../../libs/$(TARGET_ARCH_ABI)) -lvanillaworld \\\n"];
        [mkStr appendString:@"\t\t-llog -lGLESv1_CM -ljnigraphics\n\n"];
